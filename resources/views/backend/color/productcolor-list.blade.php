...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
      <h5 class="text-center">All Product Color ({{ $color_count }})</h5>
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              @endif
              <a href="{{ route('ProductBrandAdd') }}" class="btn btn-pink" style = "float: right">Add New Product Color <i class="fa fa-plus"></i></a>
              <br>
              <form action="{{ route('ColorMultiDelete') }}" method="POST">
                @csrf
                      ...
                      <tbody>
                        @foreach($colors as $key => $data)
                          <tr class="text-center">
                            ...
                            <td>
                                <a class="btn btn-outline-info" href="{{ route('ProductColorEdit' , $data->id) }}">Edit</a>
                                <a class="btn btn-outline-danger" href="{{ route('ProductColorDelete' , $data->id) }}">Delete</a>
                            </td>
                          </tr>
                        @endforeach
                        </form>
