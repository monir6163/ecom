...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <span class="breadcrumb-item active">Add New SubCategory</span>
    </nav>
    ...
    <form action="{{ url('admin/subcategory-post') }}" method="POST">
            @csrf
        <div class="form-layout">
          <div class="row mg-b-25">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" name="subcategory_name" class="form-control @error('subcategory_name') is-invalid @enderror" value="{{ old('subcategory_name') }}" placeholder="Ex:Category Name" id="subcategory_name">
              </div>
          ...
          <div class="form-layout-footer text-center">
            <button type="submit" class="btn btn-info mg-r-5 text-center" style = "cursor: pointer">Add SubCategory</button>
