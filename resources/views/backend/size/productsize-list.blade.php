...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
      <h5 class="text-center">All Product Size ({{ $size_count }})</h5>
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              <br>
              <form action="{{ route('SizeMultiDelete') }}" method="POST">
                @csrf
                      ...
                      <tbody>
                        @foreach($sizes as $key => $data)
                          <tr class="text-center">
                            ...
                            <td>
                                <a class="btn btn-outline-info" href="{{ route('ProductSizeEdit' , $data->id) }}">Edit</a>
                                <a class="btn btn-outline-danger" href="{{ route('ProductSizeDelete' , $data->id) }}">Delete</a>
                            </td>
                          </tr>
                        @endforeach
                        </form>
