...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
      <h5 class="text-center">All Trash Product Size ({{ $trash_count }})</h5>
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              @endif
              <a href="{{ route('ProductSizeAdd') }}" class="btn btn-pink" style = "float: right">Add New Product Size <i class="fa fa-plus"></i></a>
              <br>
              <form action="{{ route('SizeMultiRestore') }}" method="POST">
                @csrf
                    ...
                    <table class="table table-bordered table-primary mg-b-0" id="datatable1">
                      ...
                      <thead>
                        <th class="text-center">All</th>
                          ...
                          <th class="text-center">Size_Name</th>
                          <th class="text-center">Created</th>
                          <th class="text-center">Deleted</th>
                          <th class="text-center">Action</th>
                      </thead>
                      <tbody>
                        @forelse($size_list as $key => $data)
                        <tr class="text-center">
                          <td><input type="checkbox" name="restore[]" value="{{ $data->id }}"></td>
                            ...
                            <td>
                                <a class="btn btn-outline-success" href="{{ route('SizeRestore' , $data->id) }}">Restore</a>
                                <a class="btn btn-outline-danger" href="{{ route('SizePermanentDelete' , $data->id) }}">PermanetDelete</a>
                            </td>
                        </tr>
                        @empty
