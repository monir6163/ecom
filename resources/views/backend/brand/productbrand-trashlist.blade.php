...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
      <h5 class="text-center">All Trash Product Brand ({{ $trash_count }})</h5>
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              <br>
              <form action="{{ route('BrandMultiRestore') }}" method="POST">
                @csrf
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td><input type="checkbox" name="restore[]" value="{{ $data->id }}"></td>
                            ...
                            <td>
                                <a class="btn btn-outline-success" href="{{ route('BrandRestore' , $data->id) }}">Restore</a>
                                <a class="btn btn-outline-danger" href="{{ route('BrandPermanentDelete' , $data->id) }}">PermanetDelete</a>
                            </td>
                        </tr>
                        @empty
