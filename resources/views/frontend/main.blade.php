                ...
                <ul class="row">
                    ...
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            <div class="product-img">
                                <span>Sale</span>
                                <img src="{{ asset('images/'.$latest_product->created_at->format('Y/m/').$latest_product->id.'/'.$latest_product->thumbnail) }}" alt="{{ $latest_product->title }}">
                                <div class="product-icon flex-style">
                                    <ul>
                                        <li><a data-toggle="modal" data-target="#exampleModalCenter{{ $latest_product->id }}" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                        <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="{{ route('SingleCart' , $latest_product->slug) }}"><i class="fa fa-shopping-bag"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="product-content">
                                <h3><a href="{{ route('SingleProduct' , $latest_product->slug) }}">{{ $latest_product->title }}</a></h3>
                                <p class="pull-left">৳ {{ $latest_product->price }}</p>
                                <ul class="pull-right d-flex">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <!-- Modal area start -->
                    <div class="modal fade" id="exampleModalCenter{{ $latest_product->id }}" tabindex="-1">
                                ...
                                <div class="modal-body d-flex">
                                    ...
                                    <div class="product-single-content w-50">
                                        ...
                                        <div class="rating-wrap fix">
                                            <span class="pull-left">৳ {{ $latest_product->price }} </span>
                                        ...
                                        <ul class="cetagory">
                                            <li>Categories:</li>
                                            <li><a href="#">{{ $latest_product->category->category_name }}</a></li>,
                                            <li>SubCategories:</li>
                                            <li><a href="#">{{ $latest_product->subcategory->subcategory_name }}</a></li>
                                        </ul>
                                        <ul class="socil-icon">
                                            <li>Share :</li>
