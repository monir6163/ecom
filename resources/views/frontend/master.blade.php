...
<head>
    ...
    <title>@yield('title' , 'Welcome To E-commerce Store') | Monir Hossain</title>
    <meta name="description" content="@yield('meta_description' , 'Hello Meta Description')">
                        ...
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img width="20" src="{{ asset('images/'.$item->product->created_at->format('Y/m/').$item->product_id.'/'.$item->product->thumbnail) }}" alt="{{ $item->product->title }}">
                                        </div>
                                        <div class="cart-content">
                                            <a href="{{ route('Cart') }}">{{ $item->product->title }}</a>
